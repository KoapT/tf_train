...
TrainItem = collections.namedtuple(
        ...
        [
         ...
         'ver_list',  # A trainable veriable list applied to gradients of the loss,
                      # if it is none, all the trainable veriables in the graph will be as default, 
...
#=============================    
    ...
    @abstractmethod
    def inferrence(self, graph, sess, feeds, model_info_path, sample_info_path):
