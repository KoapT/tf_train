...
flags.DEFINE_string('images_dir', '/home/psdz/Pictures',
                    'Images directory')

flags.DEFINE_string('pb_path',
                    '/home/psdz/TK/tensorFlowTrain/samples_to_train/ObjectDetectExample/train_dir/saved_model/model_608.pb',
                    'Check point path')
...
flags.DEFINE_string('sample_info_path',
                    '/home/psdz/TK/tensorFlowTrain/samples_to_train/ObjectDetectExample/LabelMap/label_map.json',
        ...
        with tf.Session() as sess:
            ...
            for imagePath in imagePathList:
                ...
                results = postprocess_utils.nms_np(logits_np, iou_threshold=0.45,
                                                   confidence_threshold=0.3, coco_id=coco_id)  # xywh
