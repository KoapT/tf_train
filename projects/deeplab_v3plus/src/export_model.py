...
from inputs import input_preprocess
...
flags.DEFINE_string('label_map_path', 'LabelMap/label_map.json', 'Label map path.')
...
#test------------------------
#FLAGS.checkpoint_path='/home/rick/ImageRecognition/tensorFlowTrain/samples_to_train_seg/Pascal/train_dir/model.ckpt-1'
#FLAGS.export_path='/home/rick/ImageRecognition/tensorFlowTrain/samples_to_train_seg/Pascal/train_dir/frozen_inference_graph.pb'
...
def _create_input_tensors():
  ...
  _, image, _ = input_preprocess.preprocess_image_and_label(
      image,
      label=None,
...
def main(unused_argv):
  ...
  FLAGS.crop_size = [cfg['crop_size_height'], cfg['crop_size_width']]
  FLAGS.inference_scales = cfg['inference_scales']
  ...
  num_classes = len(param_file_access.get_json_params(FLAGS.label_map_path))
