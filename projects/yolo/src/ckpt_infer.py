...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        saver = tf.train.import_meta_graph('/home/psdz/TK/tensorFlowTrain/projects/yolo/run/pretrain_models/Object_Detection/model_608.ckpt.meta')
        saver.restore(sess, tf.train.latest_checkpoint('/home/psdz/TK/tensorFlowTrain/projects/yolo/run/pretrain_models/Object_Detection'))
        ...
        for imagePath in imagePathList:
            ...
            model_input = graph.get_tensor_by_name('input_image:0')
            model_output = graph.get_tensor_by_name('output_label:0')
            feed_dict = {model_input:images}

            # Run inference
            logits_np = sess.run(model_output,feed_dict)
